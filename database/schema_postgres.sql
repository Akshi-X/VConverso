-- Language Learning Management System Schema for PostgreSQL / Supabase
-- Designed for PostgreSQL

-- 1. User Table (Named users to avoid reserved keyword conflicts in PostgreSQL)
...
- **der** becomes **den** (e.g., *Ich have **den** Apfel* - I have the apple)
- **die** remains **die**
- **das** remains **das**
...
-- --------------------------------------------------------
-- SYNCHRONIZE SERIAL SEQUENCE VALUES
-- --------------------------------------------------------
...
SELECT setval('qs_question_id_seq', (SELECT MAX(question_id) FROM Qs));
